...
Transfer reinforcement learning locomotion policies trained in **Isaac Lab** (NVIDIA PhysX) to **MuJoCo** without retraining. Evaluated on two robots with fundamentally different morphologies:
...
- [Cassie MuJoCo](https://github.com/osudrl/cassie-mujoco-sim) - Cassie robot model
